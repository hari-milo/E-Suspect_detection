        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="Firhistory.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>FIR History</p>
                </a>
              </li>
                ...
                <div class="card-body table-responsive">
                  ...
                  <script>
                    function search() {
                      $.ajax({
                        type: "GET",
                        url: "../Ajax/search.php?key=" + $('#ser').val(),
                  ...
                  <div class="row">
                    <div id="txtHint" class="col-md-12 table-responsive" style="max-height: 100vh;overflow-x:scroll">
                      <table id="mytable" class="table table-striped table-hover table-bordered  border-top ">
                        ...
                        <tbody>
                          <?php
                          $count = mysqli_query($conn, "select * from tbl_fir a,tbl_crimecategory b  where a.crime=b.Crimeid  and a.Station='$pid' and a.Policeremark!='Charge Sheet Issued'");
