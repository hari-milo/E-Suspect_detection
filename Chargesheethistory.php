        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="Chargesheethistory.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <section class="col-lg-12 connectedSortable">
              <div class="card" data-aos="fade-up">
                <div class="card-header">
                  <h3 class="card-title">
                    <i class="fas fa-users mr-1"></i> Chargesheet  Details
                  </h3>
                ...
                <div class="card-body table-responsive">
                  ...
                  <script>
                    function search() {
                      $.ajax({
                        type: "GET",
                        url: "../Ajax/search1.php?key=" + $('#ser').val(),
                  ...
                  <div class="row">
                    <div id="txtHint" class="col-md-12 table-responsive" style="max-height: 100vh;overflow-x:scroll">
                      <table id="mytable" class="table table-striped table-hover table-bordered  border-top ">
                        ...
                        <tbody>
                          <?php
                          $count = mysqli_query($conn, "select * from tbl_chargesheet a,tbl_section b, tbl_police c  where a.Section=b.Sectionid  and a.Nameinvest=c.Policid and a.Status!='Charge Sheet Completed' and c.Station='$pid'");
                          ...
                          ?>
                            ...
                            <a href="Chargesheet.php?fid=<?php echo $row['Firnumber']?>" class="btn bg-gradient-indigo btn-sm round-rd elevation-2" title="Add more details"><i class="fas fa-plus"></i
                            ></a>                       
                          </td>
                            </tr>
                          <?php
