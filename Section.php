      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Section Details</h1>
              </div>
              <!-- /.col -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="row">
                      <div class="col-sm-12 table-responsive">
                        ...
                        >
                          ...
                          $id=1;
                          $id1=0;
          $quer="select * from tbl_section";
                    $count=mysqli_query($conn,$quer);
                    $quer1="select count(*) as a from tbl_section";
        ...
        while($row1=mysqli_fetch_array($count1))
    {
                   ...
                   while($id<=$id1)
                   {
                    ...
                    ?>
                            ...
                            <a
                              href="Dele2.php?hid=<?php echo $row['Sectionid']; ?>"
...
$name=$_POST['txtname'];
$Des=$_POST['txtaddres'];
$sql= "INSERT INTO `tbl_section`(`Section`, `Sdes`) VALUES  ('$name','$Des')";
