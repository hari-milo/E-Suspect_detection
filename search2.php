<table  id="mytable" class="table table-striped table-hover table-bordered border-info border-top ">
                    ...
                    if(!empty($key)){
                        if($f==0){
                            $quer='select * from tbl_fir a,tbl_crimecategory b  where a.crime=b.Crimeid  and a.Firnumber like "'.$key.'%" ';
                            $f=1;
                        }
                        else
                        {
                            $quer="select * from tbl_fir a,tbl_crimecategory b  where a.crime=b.Crimeid";
                        }
                    }
                    else{
                        $quer="select * from tbl_fir a,tbl_crimecategory b  where a.crime=b.Crimeid";
