      ...
      <p>
          Home
                ...
                <li class="nav-item active">
                    <a href="police.php" class="nav-link active">
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Police</h1>
              </div>
              <!-- /.col -->
            </div>
            <!-- /.row -->
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <form action="police.php" method="post">
                <div class="card-header">
                  <h5 class="card-title m-0"><i class="fa fa-user-plus"></i> Add Police Details</h5>
                </div>
                  <div class="card-body">
                    <div class="row">
                    <div class="col-md-6 col-sm-6 col-xm-12 ">
                      ...
                      <div class="col-md-6 col-sm-6 col-xm-12 ">
                        <label for="Name">Police Id *</label>
                        <input type="text" name="police" required class="form-control" id=""
...
$sql= "INSERT INTO `tbl_police`(`Station`, `Policid`, `Name`, `Email`, `Mobile`, `Address`) VALUES ('$sata','$police','$name','$email','$phone','$addres')";
