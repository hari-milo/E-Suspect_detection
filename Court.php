      ...
      <p>
          Home
                ...
                <li class="nav-item active">
                    <a href="Court.php" class="nav-link active">
                ...
                <li class="nav-item ">
                    <a href="Prison.php" class="nav-link ">
                        <i class="nav-icon fas fa-home"></i>
                        <p>
                        Prison Details
                        </p>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Court Details</h1>
              </div>
              <!-- /.col -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="row">
                      <div class="col-md-6 col-sm-6 col-xm-12 ">
                        ...
                        <input type="text" name="txtname" required class="form-control" id="" 
                          placeholder="Please enter Court Name" title="Enter your Court Name" />
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-12 table-responsive">
                        ...
                        >
                          ...
                          $id=1;
                          $id1=0;
          $quer="select * from tbl_court";
                    $count=mysqli_query($conn,$quer);
                    $quer1="select count(*) as a from tbl_court";
        ...
        while($row1=mysqli_fetch_array($count1))
    {
                   ...
                   while($id<=$id1)
                   {
                    ...
                    ?>
                            ...
                            <a
                              href="Dele.php?hid=<?php echo $row['Courtid']; ?>"
...
if(isset($_POST['submit']))
 {
$name=$_POST['txtname'];
$sql= "INSERT INTO `tbl_court`(`Courtname`) VALUES  ('$name')";
